var algorithms = (function () {
    ...
    self.initDialog = function (label) {
        if (label)
            common.fillSelectOptionsWithStringArray(searchDialog_AlgorithmsTargetLabelSelect, Schema.getPermittedLabels(label,true,true), true)
        else
            toutlesensController.initLabels(searchDialog_AlgorithmsTargetLabelSelect, true);

        common.fillSelectOptionsWithStringArray(searchDialog_algorithmSelect, Object.keys(self.algorithms))
